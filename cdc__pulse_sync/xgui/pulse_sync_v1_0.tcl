...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "TOGGLE_EARLY" -parent ${Page_0} -widget comboBox
...
proc update_PARAM_VALUE.TOGGLE_EARLY { PARAM_VALUE.TOGGLE_EARLY } {
	# Procedure called to update TOGGLE_EARLY when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TOGGLE_EARLY { PARAM_VALUE.TOGGLE_EARLY } {
	# Procedure called to validate TOGGLE_EARLY
	return true
}
...
proc update_MODELPARAM_VALUE.TOGGLE_EARLY { MODELPARAM_VALUE.TOGGLE_EARLY PARAM_VALUE.TOGGLE_EARLY } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TOGGLE_EARLY}] ${MODELPARAM_VALUE.TOGGLE_EARLY}
}
